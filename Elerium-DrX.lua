				...
				do -- Tab Elements
						...
						spawn(function()
							while true do
								if button and button:GetChildren()[1] then
									button:GetChildren()[1].ImageColor3 = Color3.fromRGB(42,42,42)
								end
								RS.Heartbeat:Wait()
							end
						end)
					...
					function tab_data:AddSwitch(switch_text, callback) -- [Switch]
						...
						spawn(function()
							while true do
								if switch and switch:GetChildren()[1] then
									switch:GetChildren()[1].ImageColor3 = Color3.fromRGB(42, 42, 42)
								end
								RS.Heartbeat:Wait()
							end
						end)
						...
						function switch_data:Set(bool)
							...
							switch.Text = false and utf8.char(10003) or ""
							pcall(callback,toggled)
						end
